...
void StatisticsPage::updateStatistics()
{
    ...
    {
        ui->heightBox->setText("<b><font color=\"#c17724\">" + height + "</font></b>");
    } else {
    ...
    {
        ui->minBox->setText("<b><font color=\"#c17724\">" + stakemin + "</font></b>");
    } else {
    ui->minBox->setText(stakemin);
    }
    if(0 > stakemaxPrevious)
    {
        ui->maxBox->setText("<b><font color=\"#c17724\">" + stakemax + "</font></b>");
    } else {
    ...
    {
        ui->cBox->setText("<b><font color=\"#c17724\">" + phase + "</font></b>");
    } else {
    ...
    {
        ui->rewardBox->setText("<b><font color=\"#c17724\">" + subsidy + "</font></b>");
    } else {
    ...
    {
        ui->diffBox->setText("<b><font color=\"#c17724\">" + hardness + "</font></b>");        
    ...
    {
        ui->diffBox2->setText("<b><font color=\"#c17724\">" + hardness2 + "</font></b>");
    ...
    {
        ui->pawrateBox->setText("<b><font color=\"#c17724\">" + pawrate + " MH/s</font></b>");
    ...
    {
        ui->localBox->setText("<b><font color=\"#c17724\">" + Qlpawrate + "</font></b>");
    } else {
    ...
    {
        ui->connectionBox->setText("<b><font color=\"#c17724\">" + QPeers + "</font></b>");             
    ...
    {
        ui->volumeBox->setText("<b><font color=\"#c17724\">" + qVolume + " SAR" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " SAR" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " SAR");
    }
